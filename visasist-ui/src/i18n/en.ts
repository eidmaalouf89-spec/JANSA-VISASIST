const en = {
  ...
  // Workspace P3
  ws_breadcrumb_queue: 'Queue',
  ws_not_found: 'Document not found',
  ws_not_found_sub: 'No document matches this key.',
  ws_tab_overview: 'Overview',
  ws_tab_history: 'Revision History',
  ws_tab_approvers: 'Approvers',
  ws_tab_analysis: 'Analysis',
  ws_tab_raw_norm: 'Raw \u2194 Norm',
  ws_tab_logs: 'Logs',
  ws_decision_issue_vao: 'Issue VAO',
  ws_decision_issue_ref: 'Issue REF',
  ws_decision_chase: 'Chase approvers',
  ws_decision_hold: 'Hold',
  ws_confidence: 'confidence',
  ws_score_overdue: 'Overdue',
  ws_score_deadline: 'Deadline proximity',
  ws_score_completeness: 'Completeness',
  ws_score_revision: 'Revision depth',
  ws_score_penalty: 'Deadline penalty',
  ws_score_total: 'Total',
  ws_approver_responded: 'Responded',
  ws_approver_blocking: 'Blocking',
  ws_approver_pending: 'Pending',
  ws_approver_hm: 'HM',
  ws_approver_not_assigned: 'Not assigned',
  ws_meta_reference: 'Reference',
  ws_meta_titre: 'Title',
  ws_meta_lot: 'Lot',
  ws_meta_type: 'Type',
  ws_meta_zone: 'Zone',
  ws_meta_niveau: 'Level',
  ws_meta_n_doc: 'Doc. number',
  ws_meta_format: 'Format',
  ws_meta_n_bdx: 'Bordereau',
  ws_meta_date_diffusion: 'Diffusion date',
  ws_meta_date_reception: 'Reception date',
  ws_meta_observations: 'Observations',
  ws_raw_field: 'Field',
  ws_raw_raw: 'Raw value',
  ws_raw_norm: 'Normalised',
  ws_anomaly_title: 'Import anomalies',
  ws_anomaly_column: 'Column',
  ws_anomaly_raw: 'Raw value',
  ws_anomaly_action: 'Action taken',
  ws_anomaly_confidence: 'Confidence',
  ws_draft_synthesis: 'Synthesis draft',
  ws_draft_relance: 'Chase draft',
  ws_draft_note: 'Archive note',
  ws_regenerate: 'Regenerate',
  ws_ai_validation_failed: 'Recommendation not available for this item.',
  ws_cross_lot_title: 'Cross-lot presence',
  ws_lifecycle_label: 'Status',
} as const;
